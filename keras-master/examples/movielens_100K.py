...
model.add(TimeDistributedDense(300, 25))
model.add(Activation('sigmoid'))
#model.add(Dropout(0.8))
model.add(TimeDistributedDense(25, 1))
...
history = model.fit([user ,Items] ,y_train, nb_epoch=30, batch_size=2048, verbose=2, show_accuracy=True)
...
pfile=open(r"C:\Users\t-alie\Downloads\movieLens_1M\yp.dropout.30","w")
for y in y_p:
	pfile.write("%s\n" %y)
pfile.close()
