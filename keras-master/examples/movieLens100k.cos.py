...
history = model.fit([user ,Items] ,y_train, nb_epoch=7, batch_size=2048, verbose=2, show_accuracy=True)
...
pfile=open(r"C:\Users\t-alie\Downloads\movieLens_1M\yp_cos_relu_c","w")
for y in y_p:
	pfile.write("%s\n" %y)
pfile.close()
