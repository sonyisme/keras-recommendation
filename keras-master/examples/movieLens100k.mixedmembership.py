...
##itemModel.add(Dense(4, 2))
model2=Sequential()
model2.add(Cosine([userModel2,itemModel2])) #should output 2 values 
...
##itemModel.add(Dense(4, 2))
model3=Sequential()
model3.add(Cosine([userModel3,itemModel3])) #should output 2 values 
...
##itemModel.add(Dense(4, 2))
model4=Sequential()
model4.add(Cosine([userModel4,itemModel4])) #should output 2 values 
...
##itemModel.add(Dense(4, 2))
model5=Sequential()
model5.add(Cosine([userModel5,itemModel5])) #should output 2 values 
...
##itemModel.add(Dense(4, 2))
model6=Sequential()
model6.add(Cosine([userModel6,itemModel6])) #should output 2 values 
...
##itemModel.add(Dense(4, 2))
model7=Sequential()
model7.add(Cosine([userModel7,itemModel7])) #should output 2 values 
...
history = model.fit([user ,Items,user ,Items,user ,Items,user ,Items,user ,Items,user ,Items,user ,Items] ,y_train, nb_epoch=7, batch_size=2048, verbose=2, show_accuracy=True)
...
y_p=model.custom_predict([user_test ,Items_test,user_test ,Items_test,user_test ,Items_test,user_test ,Items_test,user_test ,Items_test,user_test ,Items_test,user_test ,Items_test],scoring)
#y_pp=model.predict([user_test,Items_test])
pfile=open(r"C:\Users\t-alie\Downloads\movieLens_1M\yp_cos_relu_7submodels","w")
for y in y_p:
	pfile.write("%s\n" %y)
pfile.close()
...
model.save_weights(r'f:\maxtopic_7submodels.model')
#print('done saving')