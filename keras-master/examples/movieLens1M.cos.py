...
print("Loading data...")
load_dataset(r"D:\users\t-alie\Deepfactorization\movielens.users_50p_5min_centeresMean_manyNeg",r"D:\users\t-alie\Deepfactorization\movielens.items_pos_50p_5min_centeresMean_manyNeg",r"D:\users\t-alie\Deepfactorization\movielens.items_neg_50p_5min_centeresMean_manyNeg0",1)
print(samples)
...
userModel.add(Dense(userfea, 300))
...
itemModel.add(TimeDistributedDense(itemfea, 300))
...
for i in range(0,30):
	...
	curline=0;
	model.save_weights(r'C:\Users\t-alie\Downloads\1cos.model.itr'+`i`)

print('done training')
load_dataset(r"D:\users\t-alie\Deepfactorization\movielens.userstest_50p_5min_centeresMean_manyNeg.centered",r"D:\users\t-alie\Deepfactorization\movielens.itemstest_50p_5min_centeresMean_manyNeg",r"D:\users\t-alie\Deepfactorization\movielens.itemstest_50p_5min_centeresMean_manyNeg.fakeneg")
pfile=open(r"C:\Users\t-alie\Downloads\yp_cos.batch","w")
for j in range(0,int(samples/batchsize+.05)):
...
model.save_weights(r'C:\Users\t-alie\Downloads\1cos.model.final')
