...
model.add(TimeDistributedDense(300, 30))
model.add(Activation('tanh'))
model.add(TimeDistributedDense(30, 1))
model.add(Reshape(2))
...
print('done training')
load_dataset(r"D:\users\t-alie\Deepfactorization\movielens.userstest_50p_5min_centeresMean_manyNeg.2048.centered",r"D:\users\t-alie\Deepfactorization\movielens.itemstest_50p_5min_centeresMean_manyNeg",r"D:\users\t-alie\Deepfactorization\movielens.itemstest_50p_5min_centeresMean_manyNeg.fakeneg")
pfile=open(r"D:\users\t-alie\Deepfactorization\yp_hidden.batch","w")
for j in range(0,int(samples/batchsize+.05)):
